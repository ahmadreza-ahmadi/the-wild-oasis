...
import type { getStaysAfterDate } from '@/features/bookings/services';
...
function prepareData(
  ...
  stays: Awaited<ReturnType<typeof getStaysAfterDate>>
) {
  // A bit ugly code, but sometimes this is what it takes when working with real data 😅

  function incArrayValue(
    arr: typeof startData,
    field: (typeof startData)[number]['duration']
  ) {
    return arr.map((obj) =>
